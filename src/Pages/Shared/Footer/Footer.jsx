...
const Footer = () => {
    return (
        <footer>
        <div className="footer p-10 bg-teal-500 text-neutral-content">
            <div>
                ...
                <p>Task Management<br />Providing Easy Way to Manage task </p>
            </div>
            <div>
        ...
        <div className="p-4 footer-center bg-base-300 text-base-content">
                <div>
                    <p>Copyright © 2023 - All right reserved by Fresh farm</p>
                </div>
            </div>
    </footer>
    );
